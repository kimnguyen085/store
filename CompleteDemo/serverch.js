...
(function (port) {
    ...
    app.get('/import',function(req,res){
    	fs.readFile('UI.html', function(err, page) {
	        res.writeHead(200, {'Content-Type': 'text/html'});
	        res.write(page);
	        res.end();
	    }); 
    ...
    app.post('/import',function(req,res){
    	...
    	var files=[directory];
    	imprt.importdata(files,function(err,result,heads){
    ...
    app.post('/view',function(req,res){    	    
    	...
    	form.on('field', function (name, value) {
            ...
            {            	
            		var start=value;
            		var startpos=((start-0)+1);
            		var endpos=((start-0)+5);
            		console.log("Start at: "+startpos +" End at "+endpos);
//            		
            		db.mapreduce.add(
                			  {bucket: 'data', index: 'inx_int', start: startpos, end: endpos}).
                			    map('Riak.mapValues').run(function(err,dataarr){if(err) console.log(err);
                			    console.log('DATACONTENT '+dataarr);
                			    ...
                			    dataarr.forEach(function(member){                			    	
                			    	if(dataarr.indexOf(member)+1===dataarr.length){
...
//    	console.log(JSON.stringify(header));
    ...
    app.post('/setDirectory',function(req,res){    
    	...
    	form.on('field', function (name, value) {
            ...
            if(name==='directory')
            	{
            		directory="tmp/"+value;
            		console.log("Successful set directory: "+directory);
            	}
