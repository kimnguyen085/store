...
/**
 * Tab Rollover Messages
 **/
window.TabRolloverMessages = TabContentView.extend({
	...
	prepareContent : function() {
		...
		this.messagesFilter = new GenericElementView({
			...
			templateName : 'partial/tab-rollover-messages-filter',
    ...
    clearData: function(){
        ...
        this.messagesFilter.$el.find("#Messages-source-ABN").val('All').selectmenu('refresh');
        this.messagesFilter.$el.find("#Messages-source-USI").val('All').selectmenu('refresh');
