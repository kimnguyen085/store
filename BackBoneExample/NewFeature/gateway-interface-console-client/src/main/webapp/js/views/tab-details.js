window.TabDetails = TabContentView.extend({
	...
	drawPartAccordion : function() {
		...
		_.each(this.model.attributes.ebmsMessageParts, function(aPart) {
			self.partAccordionView.sections.push(new PartSection({
...
window.DetailSection = AccordionSection.extend({
	initialize : function() {
		...
		this.defaultLabel = {
			...
			isPartSection: true,
			sourceParticipantName : this.model.parent.attributes.sourceParticipantId ? this.model.parent.attributes.sourceParticipantId.name : "",
			sourceParticipantProductName : this.model.parent.attributes.sourceParticipantId ? this.model.parent.attributes.sourceParticipantId.productName : "",
	...
	drawDetailTitle : function() {
		this.detailTitle = new GenericElementView(_.extend({
			templateName : 'partial/message-details-title',
...
window.PartSection = DetailSection.extend({

	initialize : function() {
		DetailSection.prototype.initialize.apply(this, arguments);
	...
	loadData : function() {
		DetailSection.prototype.loadData.apply(this, arguments);
	...
	drawTransactionAccordion : function() {
		...
		this.model.transactions.each(function(transaction) {
			self.transactionAccordionView.sections.push(new TransactionSection({
				model : transaction
			}));
		});
	...
	drawContent : function() {
		...
		if (this.transactionReady || this.transactionError) {
			DetailSection.prototype.drawContent.apply(this, arguments);
		}
	}
});

window.TransactionSection = DetailSection.extend({
	initialize : function() {
		DetailSection.prototype.initialize.apply(this, arguments);
