window.BasePage = GenericPage.extend({
	...
	createPanelMenu: function () {
		this.panelMenuListView = new AdvancedMenu({
			selectIndex: this.menuIndex,
			subIndex: this.subMenuIndex,
			pageId: this.pageId
		});
	...
	updateContentHeight : function() {
		...
		this.leftMenuPanel.$el.width('330px');
	...
	pageInitHandler : function() {
		//remove the first child class
		this.panelMenuListView.$el.find('.ui-collapsible-content').find('li:first-child').removeClass("ui-first-child");
