requirejs.config({
	...
	paths : {
		...
		//menu
		rolloverMessagePage: 'js/views/rollover-message-page',
		contributionMessagePage: 'js/views/contribution-message-page',
		administrationPage: 'js/views/administration-page',
		...
		//tab messagePage
		tabDailySummaryRollover: 'js/views/tab-daily-summary-rollover',
		tabDailySummaryContribution: 'js/views/tab-daily-summary-contribution',
		tabRolloverMessages: 'js/views/tab-rollover-messages',
		tabContributionMessages: 'js/views/tab-contribution-messages',
		tabDetails: 'js/views/tab-details',
		tabContributionDetails: 'js/views/tab-contribution-details',
	...
	shim : {
		...
		//Menu page
		'rolloverMessagePage' : {
			deps : ['basePage', 'tabDetails', 'tabDailySummaryRollover', 'tabSendOutgoing', 'tabRolloverMessages']
		},
		'contributionMessagePage' : {
			deps : ['basePage', 'tabContributionDetails', 'tabDailySummaryContribution', 'tabSendOutgoing', 'tabContributionMessages']
		},
		'administrationPage' : {
			deps : ['basePage']
		},
		...
		//Router
		'appRouter' : {
			deps : ['commonActions', 'commonView', 'jqueryJgrowl', 'commonPage', 'jqueryi18n', 'rolloverMessagePage','contributionMessagePage', 'loadFVSPage', 'administrationPage']
		}
